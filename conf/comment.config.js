...
module.exports = {
  ...
  COMMENT_ARTALK_JS:
    ...
    'https://cdnjs.nankoyo.com/ajax/libs/artalk/2.9.1/Artalk.js', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS:
    process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS ||
    'https://cdnjs.nankoyo.com/ajax/libs/artalk/2.9.1/Artalk.css', // ArtalkServert css cdn
