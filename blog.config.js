...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '云谷引擎', // 您的昵称 例如 tangly1024
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'vallengine, 博客', // 网站关键词 英文逗号隔开
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js','https://cdn.nankoyo.com/public/cache/blog/js/cf-cdn.js','https://v1.hitokoto.cn/?encode=js&select=%23hitokoto','https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.0/sweetalert.min.js','https://cdn.nankoyo.com/public/cache/star/js/announcement.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '云谷引擎', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
