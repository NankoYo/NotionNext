...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '云谷引擎（Vallengine）', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '云谷引擎（Vallengine）是一家专注于提供全面云计算服务的公司，我们的宗旨是通过创新技术简化IT基础设施，释放客户的创新潜能。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '云谷引擎,Vallengine', // 网站关键词 英文逗号隔开
...
CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'email@nankoyo.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '云谷引擎（Vallengine）是一家专注于提供全面云计算服务的公司，我们的宗旨是通过创新技术简化IT基础设施，释放客户的创新潜能。', // 站点描述，被notion中的页面描述覆盖
