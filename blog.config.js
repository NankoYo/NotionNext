...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Smart Pages 是一款强大的静态网页生成器软件。它具备高效的图形技术、丰富的插件与商城资源以及多样的接口。拥有直观易用的界面，在网页设计、编辑与生成方面表现出色。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://smartpages.nankoyo.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'SmartPages,程序', // 网站关键词 英文逗号隔开
...
CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'email@nankoyo.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'SmartPages', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
